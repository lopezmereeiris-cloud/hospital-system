...
const VALID_ID_PLACEHOLDER =
  ...
  encodeURIComponent(
    `<svg xmlns='http://www.w3.org/2000/svg' width='960' height='600'>
      ...
      <rect x='60' y='60' width='840' height='480' rx='20' fill='#ffffff' stroke='#d0d5dd' stroke-width='2'/>
      <text x='480' y='260' text-anchor='middle' font-family='Inter, Arial, sans-serif' font-size='34' fill='#344054' font-weight='700'>
        VALID ID PREVIEW
      </text>
      <text x='480' y='308' text-anchor='middle' font-family='Inter, Arial, sans-serif' font-size='20' fill='#667085'>
        Placeholder image
      </text>
      <text x='480' y='352' text-anchor='middle' font-family='Inter, Arial, sans-serif' font-size='18' fill='#98a2b3'>
...
const buildReceiptHtml = (beneficiary: Beneficiary, fullName: string, fullAddress: string) => {
  ...
  const lines = sortedTransactions
    .map(
      (transaction, index) => `
      <tr>
        <td style="padding: 8px 0; border-bottom: 1px dashed #d0d5dd; vertical-align: top;">
        ...
        <td style="padding: 8px 0; border-bottom: 1px dashed #d0d5dd; text-align: right; font-weight: 700;">
...
<html>
  ...
  <body>
    <div class="receipt">
      ...
      <table>
        <tr>
          <th style="text-align: left; font-size: 12px; color: #667085; padding-bottom: 6px;">DESCRIPTION / DATE</th>
          <th style="text-align: right; font-size: 12px; color: #667085; padding-bottom: 6px;">AMOUNT</th>
        </tr>
        ${lines}
      </table>
...
function InfoField({ label, value, fullWidth = false }: { label: string; value: string; fullWidth?: boolean }) {
  return (
    ...
    >
      ...
      <div style={{ fontSize: "0.9rem", color: "#1D2939", fontWeight: 500, marginTop: 4 }}>{value || "-"}</div>
    </Box>
  );
}
  ...
  if (!beneficiary) {
    return (
      <Box sx={{ maxWidth: 1180, mx: "auto" }}>
        ...
        >
          <h2 style={{ margin: 0, fontSize: "1.1rem", color: "#1A1D1F" }}>
            Beneficiary record not found
          </h2>
          <p style={{ marginTop: 8, marginBottom: 0, color: "#6F767E", fontSize: "0.9rem" }}>
    ...
    <Box sx={{ maxWidth: 1180, mx: "auto", pb: 3 }}>
      ...
      >
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 2, flexWrap: "wrap" }}>
          <Box>
            <div style={{ fontSize: "1.35rem", fontWeight: 700, color: "#101828" }}>{fullName}</div>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mt: 1.2, flexWrap: "wrap" }}>
              ...
              <Chip
                ...
                size="small"
                sx={{ bgcolor: "#F2F4F7", color: "#344054", fontWeight: 600 }}
              />
            </Box>
          </Box>

          <Box sx={{ minWidth: 260 }}>
            <div style={{ fontSize: "0.75rem", color: "#667085", fontWeight: 600 }}>Benefit Utilization</div>
            <div style={{ fontSize: "1.15rem", color: "#101828", fontWeight: 700, marginTop: 2 }}>
              {usedPct}% used
            </div>
            <LinearProgress
              variant="determinate"
            ...
            />
            <div style={{ marginTop: 8, fontSize: "0.82rem", color: "#475467", fontWeight: 600 }}>
      ...
      >
        <Box sx={{ display: "grid", gap: 2 }}>
          <Paper sx={{ p: 2.2, borderRadius: "14px", border: "1px solid #EAECF0", boxShadow: "none" }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1.5 }}>
              <PersonRoundedIcon sx={{ color: PH.green, fontSize: 18 }} />
              <div style={{ fontSize: "0.9rem", fontWeight: 700, color: "#101828" }}>Personal Information</div>
            </Box>
          ...
          <Paper sx={{ p: 2.2, borderRadius: "14px", border: "1px solid #EAECF0", boxShadow: "none" }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1.5 }}>
              ...
              <div style={{ fontSize: "0.9rem", fontWeight: 700, color: "#101828" }}>Emergency Contact</div>
            </Box>
            <Box sx={{ display: "grid", gap: 1.2, gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" } }}>
          ...
          <Paper sx={{ p: 2.2, borderRadius: "14px", border: "1px solid #EAECF0", boxShadow: "none" }}>
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 1.2, mb: 1.4, flexWrap: "wrap" }}>
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                ...
                <div style={{ fontSize: "0.9rem", fontWeight: 700, color: "#101828" }}>Benefit Usage History</div>
              </Box>
              <Button
                variant="outlined"
                size="small"
            ...
            {sortedTransactions.length === 0 ? (
              ...
              <>
                <Box sx={{ border: "1px solid #EAECF0", borderRadius: "12px", overflow: "hidden" }}>
                  <Box
                    sx={{
                      display: "grid",
                  ...
                  >
                    <div style={{ fontSize: "0.72rem", color: "#667085", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" }}>
                      Date
                    </div>
                    <div style={{ fontSize: "0.72rem", color: "#667085", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" }}>
                      Description
                    </div>
                    <div style={{ fontSize: "0.72rem", color: "#667085", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em", textAlign: "right" }}>
                      Amount
                    </div>
                  </Box>
                  ...
                  {sortedTransactions.map((transaction, index) => (
                    <Box
                      ...
                      sx={{
                        ...
                        px: 1.5,
                        py: 1.4,
                        borderBottom: index === sortedTransactions.length - 1 ? "none" : "1px solid #F2F4F7",
                        "&:hover": { bgcolor: "#FCFCFD" },
                      }}
                    >
                      <div style={{ fontSize: "0.85rem", color: "#344054", fontWeight: 600 }}>
                        {formatDisplayDate(transaction.date)}
                      </div>
                      <div style={{ fontSize: "0.88rem", color: "#1D2939", fontWeight: 500 }}>
                        {transaction.description}
                      </div>
                      <div style={{ fontSize: "0.88rem", color: "#1D2939", fontWeight: 700, textAlign: "right" }}>
        ...
        <Box sx={{ display: "grid", gap: 2, alignContent: "start" }}>
          ...
          >
            <div style={{ fontSize: "0.8rem", color: "#667085", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.04em" }}>
              Benefit Overview
            </div>
            <div style={{ marginTop: 8, fontSize: "1.35rem", fontWeight: 700, color: PH.green }}>
              {formatCurrency(b.benefitBalance)}
            </div>
            <div style={{ fontSize: "0.82rem", color: "#475467", marginTop: 4 }}>
          ...
          <Paper sx={{ p: 2.2, borderRadius: "14px", border: "1px solid #EAECF0", boxShadow: "none" }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1.2 }}>
              ...
              <div style={{ fontSize: "0.9rem", fontWeight: 700, color: "#101828" }}>Valid ID Preview</div>
            </Box>
            <Box
              component="img"
            ...
            />
            <div style={{ marginTop: 10, fontSize: "0.78rem", color: "#667085" }}>
