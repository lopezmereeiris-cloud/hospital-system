    ...
    <FieldRow>
      ...
      <div>
        ...
        <FieldInput
          ...
          onChange={(e) => onUpdate("sssNumber", e.target.value)}
        />
      </div>
      <div>
    ...
    <div style={{ marginBottom: 20 }}>
      ...
      >
        ...
        <ul style={{ margin: 0, paddingLeft: 18, fontSize: "0.8rem", color: "grey.600", lineHeight: 1.45 }}>
          ...
          <li>ID name should match the patient registration name.</li>
        </ul>
      </div>

      <FieldLabel>Upload Valid ID Photo</FieldLabel>
      <FileUploadArea onClick={() => document.getElementById("patient-id-upload")?.click()}>
